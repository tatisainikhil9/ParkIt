...
import RemoveSpaceService from "./RemoveSpaceService"
...
class removeSpace extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data: []
    ...
    componentDidMount() {
        RemoveSpaceService.executeGetSpacesService()
            .then(
                response => {
    ...
    removeButtonClicked(id) {
        ...
        RemoveSpaceService.executeRemoveSpaceService(location, address)
            .then(
                response => {
